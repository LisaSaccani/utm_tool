...
def show_login_page():
    ...
    with c2:
        ...
        if flow:
            ...
            st.markdown(f'<a href="{auth_url}" target="_top" style="display:block; text-align:center; padding:12px 24px; background-color:#1a73e8; color:white; border-radius:8px; text-decoration:none; font-weight:bold; font-size:16px;">🔐 Login con Google Analytics</a>', unsafe_allow_html=True)
        else:
